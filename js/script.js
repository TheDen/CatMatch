...
const catFacts = [
  ...
  "Adult cats only meow to communicate with humans, not other cats 🗣️",
  "Cats have 32 muscles in each ear 👂",
  "A cat's whiskers are roughly as wide as its body 📐",
  "Slow-blinking at a cat is a sign of trust and affection 😌",
  "Cats were domesticated around 10,000 years ago in the Middle East 🏺",
  "Ancient Egyptians shaved their eyebrows in mourning when their cat died 😿",
  "Ernest Hemingway had 50+ cats and loved polydactyl ones 📚",
  "Polydactyl cats (extra toes) were considered lucky by sailors ⚓",
  ...
  "A cat's tongue is covered in tiny hollow spines called papillae 👅",
  "Cats see in colour, but not as vividly as humans 🌈",
  "Cats can see 6× better than humans in low light 🌙",
  "The world's richest cat inherited £7 million from its owner 💰",
  "Cats sleep so much to conserve energy for hunting 🎯",
  "A cat's field of vision is about 200 degrees 👁️",
  "The Maine Coon is the largest domestic cat breed 🦁",
  "Cats have a Jacobson's organ that lets them 'taste' smells 👃",
  "Cats bring home prey as gifts for their humans 🎁",
  "A cat's meow is unique — no two are exactly alike 🎵",
  "Owning a cat can lower your risk of heart disease 💖",
  "Cats have inspired more internet content than any other animal 🌐",
  "A cat's purr frequency (25–150 Hz) overlaps with bone-healing ranges 💫",
  "Cats can't move their jaw sideways, only up and down 😮",
];
